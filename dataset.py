...
class SegmentationDataset(Dataset):
    ...
    def __init__(
        ...
        self.ids = [x.split('.')[0] for x in os.listdir(images_dir)]
        self.images = [os.path.join(images_dir, image_id + '.JPG') for image_id in self.ids]
        self.masks = [os.path.join(masks_dir, image_id + '.png') for image_id in self.ids]
